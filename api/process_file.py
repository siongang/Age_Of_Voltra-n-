...
def process(json_file):
    ...
    for data in json_file:
        ...
        find_company_name = (
            ...
            "Search results will often mention the name of the company tied to the address. Respond with only the company's name or 'Unknown' if no clear association exists."
        )
